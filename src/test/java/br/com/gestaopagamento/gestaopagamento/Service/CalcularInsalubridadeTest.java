...
@Test
        ...
        Funcionario funcionarioBaixa = new Funcionario("Diogo", "12345678900", "Dev", new BigDecimal("3000.00"), false, 1, 0, 0.0, 0.0);
...
@Test
        ...
        Funcionario funcionarioAlto = new Funcionario("Diogo", "12345678900", "Dev", new BigDecimal("3000.00"), false, 3, 0, 0.0, 0.0);
